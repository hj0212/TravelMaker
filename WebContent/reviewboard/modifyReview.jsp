  ...
  crossorigin="anonymous"></script>
    ...
    <body>
		...
		<c:otherwise>
			...
			<div class="container">
            <form action="modifyReview.bo" method="post" name="writeContents">
            	<div class="form-group">
            		<input type="text" class="form-control" name="title" placeholder="제목을 입력해주세요" maxlength="50" value="${contents.review_title}">
            		<input type="text" name="articlenum" value="${articlenum}" style="display:none">
        		</div>
        		<div class="form-group">
            		<textarea name="contents" class="form-control" id="editor">${contents.review_contents}</textarea>
