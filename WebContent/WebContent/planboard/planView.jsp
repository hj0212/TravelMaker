	...
	<div class="container text-center">
		...
		<div id="view" class="wrapper row">
			<div class="left_half col-sm-12 col-lg-6">
				<div id="timeline" style="border: 1px solid gray;padding-top:5px;"></div>
			</div>
									...
									<c:forEach var="item" items="${scheduleList}">
										...
										<c:if test="${item.day_seq eq day }">
											<tr class="clickable-row">
												...
												<td name="place">${item.location_name}<input type="hidden" value="${item.location_id}">
												<input type="hidden" name="count" value="${num}"></td>
...
<script>
   ...
   $("#commentbtn").click(function() {
	...
	$("table.schedule").on('click','.clickable-row',function(event) {
		...
		var index = $("div.active #schedule-tbody tr.select td[name='place']>input[name='count']").val();
		console.log(index);
