...
<body>
	...
	<div class="container">
		...
		<div class="row writer">
			<div class="col-sm-6 text-left">${article.free_writer}</div>
		...
		<div class="comments">
			...
			<div style="width: 100%; margin: 0px;">
				<div style="width: 80%">
					<textarea class="form-control" rows="3" id="comment" style="resize: none; width: 100%; margin: 0px; float: left;" maxlength="70"></textarea>
				</div>
				<div style="width: 20%; float: left; height: 86px; margin-bottom: 30px;">
					<button style="width: 100%; height: 86px" id="comment-write-bnt">댓글작성</button>
				</div>
			</div>
			...
			<table class="table" id="comment-table">
				...
				<tbody>
					<tr>
						<th scope="row" style="width: 15%">김형섭</th>
						<td style="width: 70%; max-width: 60%;">aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa</td>
						<td style="width: 15%; font-size: 10px;">Ott</td>
					</tr>
					<tr>
						<th scope="row" style="width: 15%">2</th>
						<td style="width: 70%">Jacob</td>
						<td style="width: 15%; font-size: 10px;">Thornton</td>
					</tr>
					<tr>
						<th scope="row" style="width: 15%">3</th>
						<td style="width: 70%">Larry</td>
						<td style="width: 15%; font-size: 10px;">the Bird</td>
					</tr>
				</tbody>
			</table>
		</div>
	...
	<script>
	   ...
	   var con   =confirm("댓글을작성하시겠습니까?");   
	      ...
	      commentinput+="<tr>";
	      commentinput+="<th scope='row' style='width:15%'>"+writer+"</th>";
	      commentinput+="<td style='width:70%;max-width: 60%;'>"+comment+"</td>";
	      commentinput+="<td style='width:15%;font-size: 10px;'>"+NowTime+"</td>";
	      commentinput+="</tr>";
	   ...
	   if(con){   
	    ...
	    if(comment !=""){
	      ...
	      $("#comment-table tbody").prepend(commentinput);
	      $("#comment").val("");
