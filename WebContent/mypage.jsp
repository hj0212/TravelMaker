...
<body>
	...
	<div id="wrapper">
		<div
			class="py-5 text-center w-100 h-75 text-lowercase text-primary no-padding-bottom mt-5">
					...
					<div class="col-sm-8 col-md-3 col-lg-3">
						<div class="card w-100 h-100">
							...
							<div class="card-body h-100 py-4 my-5">
								...
								<a href="#" class="btn dropdown-toggle" id="editlink"
									data-toggle="dropdown" aria-haspopup="true"
									aria-expanded="false">정보수정</a>
				...
				<div class="panel-heading">
					<ul class="nav nav-tabs nav-justified">
						<li class="nav-item"><a href="#tabone"
							...
							role="presentation">Tab 1</a></li>
						<li class="nav-item"><a href="#tabtwo" data-toggle="tab"
							data-target="#tabtwo" role="presentation">Tab 2</a></li>
